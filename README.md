# Fresh Intellivent Sky (Alt) integration for Home Asssistant
...
3. In the `custom_components` directory (folder) create a new folder called `fresh_intellivent_sky_alt`.
4. Download _all_ the files from the `custom_components/fresh_intellivent_sky_alt/` directory (folder) in this repository.
